...
public class HelloController {
	...
	public HelloController(final RestTemplate restTemplate, final EurekaClient discoveryClient,
	...
	public String hello() {
		...
		final String theOtherResponse = restTemplate.getForObject(instance.getHomePageUrl() + "/hola-server",
				String.class);
