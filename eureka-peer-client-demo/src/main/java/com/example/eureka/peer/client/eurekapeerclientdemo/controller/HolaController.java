package com.example.eureka.peer.client.eurekapeerclientdemo.controller;
...
public class HolaController {
	...
	public HolaController(final RestTemplate restTemplate, final EurekaClient discoveryClient,
	...
	public String hola() {
		...
		final String theOtherResponse = restTemplate.getForObject(instance.getHomePageUrl() + "/hello-server",
				String.class);
